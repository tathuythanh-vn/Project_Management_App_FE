...
import ExportButtons from "@/components/dashboard/export-btn";
    ...
    return (
        <div className="rounded-md border-0 mt-2">
            ...
            <div className={'flex items-center justify-between'}>
                <div className={'p-2 border rounded-md shadow-xs w-fit flex justify-end bg-white'}>
                    <input
                        type="text"
                ...
                <ExportButtons projectData={data} />
            </div>
